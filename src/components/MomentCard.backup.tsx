...
export default function MomentCard({
  ...
  return (
    <View style={styles.card}>
      ...
      {/* 3. MEDIA SECTION WITH OVERLAY INTERACTIONS */}
      {mediaCount > 0 && (
        <View style={styles.mediaSection}>
          ...
          {/* Interaction Overlay - Đè lên ảnh */}
...
const styles = StyleSheet.create({
  ...
  // Interaction Overlay - Đè lên ảnh (ngang ở giữa phía dưới)
  interactionOverlay: {
    position: 'absolute',
    bottom: 16,
    left: '50%',
    transform: [{ translateX: -90 }], // Center horizontally (180px / 2)
    flexDirection: 'row', // Ngang
    justifyContent: 'center',
    alignItems: 'center',
    paddingVertical: 10,
    paddingHorizontal: 12,
    backgroundColor: 'rgba(0, 0, 0, 0.4)', // Nền đen mờ đậm hơn
    borderRadius: 30, // Bo tròn hoàn toàn
    gap: 8, // Khoảng cách giữa các nút
    backdropFilter: 'blur(10px)', // Hiệu ứng blur (iOS)
  },
  overlayButton: {
    width: 48,
    height: 48,
    borderRadius: 24,
    backgroundColor: 'rgba(255, 255, 255, 0.25)', // Nền trắng mờ
    justifyContent: 'center',
    alignItems: 'center',
    borderWidth: 1.5,
    borderColor: 'rgba(255, 255, 255, 0.4)', // Viền trắng mờ rõ hơn
  },
  
  mediaIndicator: {
    position: 'absolute',
    bottom: 76, // Đẩy lên trên overlay
    left: 0,
    right: 0,
    flexDirection: 'row',
    justifyContent: 'center',
